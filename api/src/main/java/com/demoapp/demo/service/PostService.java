...
public class PostService {
  ...
  private Map<String, Integer> extractReactions(JsonNode postNode) {
    ...
    } else if (reactionsNode != null && reactionsNode.isNumber()) {
      reactions.put("likes", reactionsNode.asInt(0));
